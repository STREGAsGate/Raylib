...
typedef struct Image {
    ...
    int format __attribute__((swift_private)); // Data format (PixelFormat type)
} Image;
...
typedef struct NPatchInfo {
    ...
    int layout  __attribute__((swift_private)); // Layout of the n-patch: 3x3, 1x3 or 3x1
} NPatchInfo;
...
typedef struct Camera3D {
    ...
    int projection __attribute__((swift_private)); // Camera projection: CAMERA_PERSPECTIVE or CAMERA_ORTHOGRAPHIC
} Camera3D;
